...
app.get("/load-descriptions", async (req, res) => {
  try {
    await db.query(`
     ...
     WHEN name = 'Laurent Perrier Rose' THEN 'A prestigious rosé champagne featuring delicate strawberry, raspberry and cherry flavours with exceptional elegance and fine bubbles. Perfect for celebrations and special occasions.'
WHEN name = 'Moet et Chandon Rose' THEN 'A luxurious rosé champagne offering vibrant red fruit flavours, elegant bubbles and a smooth sophisticated finish. Ideal for gifting or celebrations.'
WHEN name = 'Veuve Clicquot' THEN 'An iconic champagne renowned for rich fruit flavours, balanced acidity and fine persistent bubbles. A timeless choice for celebrations.'
WHEN name = 'Moet et Chandon Brut' THEN 'One of the world’s most recognised champagnes, showcasing citrus fruit, brioche notes and elegant bubbles with a refreshing finish.'
WHEN name = 'Thatchers Can' THEN 'A refreshing premium cider crafted from carefully selected apples, delivering crisp fruit flavours and a clean finish.'
WHEN name = 'Koppaberg Can Pear' THEN 'A Swedish pear cider bursting with juicy pear flavour and refreshing sweetness. Best served chilled over ice.'
WHEN name = 'Koppaberg Can Strawberry Lime' THEN 'A popular fruit cider blending sweet strawberry flavour with refreshing lime notes and a crisp finish.'
WHEN name = 'Koppaberg Can Mix Fruit' THEN 'A refreshing mixed fruit cider packed with berry flavours and balanced sweetness. Perfect served ice cold.'
WHEN name = 'Coors Light Can 500ml' THEN 'A light American lager with crisp refreshing flavour and clean finish. Best enjoyed ice cold.'
WHEN name = 'Guinness Zero Can' THEN 'An alcohol-free stout delivering the famous Guinness roasted malt flavour, smooth body and creamy finish without the alcohol.'
WHEN name = 'Magners Can 500ml' THEN 'A traditional Irish cider made using carefully selected apples, offering crisp fruit flavour and refreshing character.'
WHEN name = 'Rekordelig Can Passion Fruit' THEN 'A Swedish fruit cider featuring exotic passion fruit flavour and refreshing sweetness. Excellent served chilled.'
WHEN name = 'Rekordelig Can Strawberry Lime' THEN 'A refreshing fruit cider combining sweet strawberry notes with zesty lime for a crisp finish.'
WHEN name = 'Rekordelig Can Wild Berry' THEN 'A mixed berry cider packed with juicy fruit character and balanced sweetness. Refreshing and easy drinking.'
WHEN name = 'Rekordelig Can Mango Raspberry' THEN 'A tropical fruit cider blending mango sweetness with raspberry freshness and a smooth finish.'
WHEN name = 'Lucozade Sport' THEN 'A popular isotonic sports drink designed to help replenish fluids and electrolytes during and after exercise.'
WHEN name = 'Walkers' THEN 'Classic potato crisps made from quality potatoes and available in a variety of popular flavours. Perfect for snacking any time of day.'
WHEN name = 'Fevertree Pink Grapefruit' THEN 'A premium pink grapefruit soda offering vibrant citrus flavour and refreshing bitterness. Ideal for premium mixed drinks.'
WHEN name = 'Carlsberg Bottle 330ml' THEN 'A smooth Danish pilsner with balanced malt flavour and refreshing crisp finish. Best served chilled.'
WHEN name = 'Fevertree Mediterranean Tonic' THEN 'A premium tonic water infused with Mediterranean herbs and citrus notes. Perfect for enhancing premium gin serves.'
WHEN name = 'Fevertree Sicillian Lemonade' THEN 'A refreshing sparkling lemonade crafted with Sicilian lemons, delivering vibrant citrus flavour and natural sweetness.'
WHEN name = 'Fevertree Elderflower Tonic' THEN 'A delicate tonic water infused with elderflower notes, creating a light floral character ideal for premium gins.'
WHEN name = 'Fevertree Soda' THEN 'A premium soda water with fine carbonation and a clean refreshing finish. Perfect as a mixer for spirits and cocktails.'
        ELSE description

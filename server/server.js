  ...
  try {
    await db.query(`
      ...
      FROM (
        ...
        ('AU Watermelon', 'A premium watermelon flavoured vodka with refreshing fruit sweetness and a smooth finish. Perfect with lemonade or soda.'),
('AU Bubblegum', 'A sweet bubblegum flavoured vodka with a nostalgic candy taste. Popular for shots and party drinks.'),
('Rushkinoff Caramel', 'A caramel flavoured vodka with rich sweetness and a smooth finish. Ideal served chilled or over ice.'),
('Rushkinoff Mix Fruit', 'A mixed fruit flavoured vodka packed with sweet fruity character. Perfect for parties and cocktails.'),
('Rushkinoff Strawberry', 'A strawberry flavoured vodka with juicy berry sweetness and smooth finish.'),
('Rushkinoff Vanilla', 'A vanilla flavoured vodka offering sweet creamy notes and a smooth character.'),
('Rushkinoff Strawberry Lime', 'A fruit flavoured vodka combining sweet strawberry and zesty lime flavours.'),
('Captain Morgan', 'A spiced rum with vanilla, caramel and warming spice notes. Excellent with cola and mixed drinks.'),
('Bacardi Black', 'A dark rum with rich oak, vanilla and caramel flavours. Ideal for cocktails and cola drinks.'),
('Bacardi Carta Fuego', 'A spiced rum with cinnamon heat and warming flavour. Great for shots or spicy cocktails.'),
('Bacardi Lemon', 'A lemon flavoured rum with bright citrus notes and refreshing character.'),
('Bacardi Razz', 'A raspberry flavoured rum with sweet berry notes and smooth finish.'),
('Cachaza', 'A Brazilian sugarcane spirit used in caipirinhas and tropical cocktails.'),
('Johnny Walker Blue Label', 'A luxury blended Scotch whisky with rich complexity, smooth texture and exceptional depth.'),
('Johnny Walker Red Label', 'A blended Scotch whisky with bold flavour and light smoky notes. Perfect for mixers.'),
('Talisker', 'An island single malt Scotch whisky with maritime influence and gentle smoky character.'),
('Glenkinchie', 'A Lowland single malt whisky with floral notes, smooth texture and light citrus character.'),
('Glenmorangie', 'A Highland single malt whisky with vanilla, fruit and oak flavours.'),
('Goldenheart', 'A blended whisky with smooth flavour, gentle sweetness and approachable character.'),

('Lucozade Original', 'A sparkling glucose energy drink with a distinctive flavour and refreshing taste.'),
('Monster Can', 'A high caffeine energy drink with bold flavour and a refreshing finish.'),
('Red Bull Can', 'A world-famous energy drink offering a refreshing taste and energy boost.'),
('Boost', 'An energy drink with caffeine and vitamins designed for refreshment and stimulation.'),
('Aquarius Lemon Can', 'A lemon flavoured isotonic drink designed to help hydration and refreshment.'),
('Aquarius Orange Can', 'An orange flavoured isotonic drink with refreshing citrus character.'),
('Old Jamaica Ginger Beer', 'A fiery ginger soft drink with bold flavour and refreshing spice.'),
('Fevertree Ginger Ale', 'A premium ginger ale mixer with balanced ginger flavour and clean finish.'),
('Fevertree Ginger Beer', 'A premium ginger beer with rich ginger spice and refreshing flavour.'),
('Schweppes Ginger', 'A classic ginger mixer with smooth spice and refreshing character.'),
('Schweppes Tonic', 'A crisp tonic water with balanced bitterness. Ideal for gin and tonic serves.'),
('Robinsons Blackcurrant', 'A concentrated fruit cordial with rich blackcurrant flavour.'),
('Fruit Shoot', 'A fruit flavoured children’s soft drink with refreshing taste and convenient bottle format.'),

('Beans', 'Classic baked beans in tomato sauce. Ideal for breakfasts, lunches and quick meals.'),
('Branston Pickle', 'A traditional British pickle packed with sweet and tangy vegetable flavour.'),
('Colmans Mustard', 'A classic English mustard with a strong and distinctive flavour.'),
('Corned Beef', 'A tinned cooked beef product suitable for sandwiches, salads and meals.'),
('Heinz Ketchup', 'A rich tomato ketchup made from sun-ripened tomatoes.'),
('HP Sauce', 'A traditional brown sauce with tangy and fruity flavour.'),
('Lea and Perrins', 'The famous Worcestershire sauce with a rich savoury flavour profile.'),
('Mint Sauce', 'A classic mint condiment often served with lamb dishes.'),
('Mushy Peas', 'Traditional mushy peas perfect with pies, fish and chips and hearty meals.'),
('Sarsons Vinegar', 'A traditional malt vinegar ideal for seasoning food and cooking.'),
('Soup Chicken', 'A ready-to-heat chicken soup with comforting flavour and warming character.'),
('Soup Tomato', 'A smooth tomato soup with rich tomato flavour.'),
('Tabasco', 'A famous hot sauce made from aged peppers with a spicy kick.'),

('Crumpets Pack 6', 'Traditional crumpets with a soft texture and distinctive toasted flavour.'),
...
('Steak Guinness Pie', 'A hearty pastry pie filled with steak and rich Guinness gravy.'),
('YOrkshire Puddings Bag 20', 'Traditional Yorkshire puddings ideal for roast dinners and family meals.'),
('Yorkshire Puddings Single', 'A traditional Yorkshire pudding perfect as a side for roast dinners.'),
('Hash Brown 2.5KG', 'Golden crispy potato hash browns ideal for breakfasts and catering use.'),
('Chips 2.5KG bag', 'Frozen potato chips suitable for oven or fryer preparation.')
